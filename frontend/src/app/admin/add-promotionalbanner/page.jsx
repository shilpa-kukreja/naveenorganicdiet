...
const PromotionalBannerAdmin = () => {
  ...
  const fetchBanners = async () => {
    try {
      ...
      setBanners(response.data.promotionalbanners || []);
    } catch (error) {
  ...
  const handleUpdateImage = async (id) => {
    ...
    try {
      ...
      await axios.put(`${API_URL}/update-image/${id}`, formData, {
        headers: {
          'Content-Type': 'multipart/form-data'
        }
      });
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-600 mt-2">Manage your promotional banner images (Displayed in groups of 3)</p>
          </div>
          <button
